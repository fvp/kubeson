...
import com.sun.javafx.scene.control.behavior.TableComboBoxListViewBehavior;
...
public class TableComboBoxListViewSkin<T> extends ComboBoxPopupControl<T> {
    ...
    public TableComboBoxListViewSkin(final TableComboBox<T> comboBox) {
        super(comboBox, new TableComboBoxListViewBehavior<T>(comboBox));
    ...
    public Object queryAccessibleAttribute(AccessibleAttribute attribute, Object... parameters) {
        switch (attribute) {
            ...
            case SELECTION_START:
                return getEditor().getSelection().getStart();
            case SELECTION_END:
                return getEditor().getSelection().getEnd();
            default:
